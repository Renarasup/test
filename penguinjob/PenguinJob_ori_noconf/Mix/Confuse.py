...
class ConfuseBiz(object):
    ...
    def confuse_text(text):
        firstArray = ['delete', 'up', 'token', 'refresh', 'jump','do', 'minues', 'add', 'plus', 'is','shelf' , 'key', 'fork', 'lead', 'gesture', 'border', 'differ', 'toll', 'grant', 'position', 'set', 'rotate', 'meet', 'go', 'deal', 'repeat']
        secondArray = ['Pack', 'ClientInfo', 'AlbumInfo', 'Round', 'General', 'Talk', '','Shake', 'dDive', 'Employee', 'Mention', 'Spot', 'Ready', 'Response', 'Commis', 'Consider', 'Fonsider', 'Update', 'Arrow']
        thirdArray = ['By', 'Of', 'With', 'And', 'From', 'To', 'In','At','For','Yet','So','Or','Nor','Until','When','Since','If']
        forthArray = ['Home', 'DrawMap', 'UserID', 'Text', 'Location', 'User','Limited','Item','Official','Layer','Sound','Analysis','Launch','State','Seize','Whole']
        fifthArray = ['Info', 'Count', 'Name', 'GeneralID', 'Paragraph', 'Topic', 'Subtitle', 'Private', 'Recommend', 'Visual', 'Generator', 'Add', 'Assembler', 'File', 'Binary', 'Model', 'Compiler', 'Control', 'Flow', 'Event']
