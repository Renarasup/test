...
-(void)getDataANOWPenguino
{
    ...
    if ([userType isEqualToString:@"2"]) {
        ...
        if (isLogin) {
            LeftMenuArrayPenguino = [[NSArray alloc] initWithObjects:@"PenguinLatest Jobs",@"Categories",@"Saved Jobs",@"Profile",@"About Us",@"Privacy Policy",@"Logout", nil];
            ...
            LeftMenuArrayPenguino = [[NSArray alloc] initWithObjects:@"PenguinLatest Jobs",@"Categories",@"Saved Jobs",@"About Us",@"Privacy Policy", @"Login", nil];
