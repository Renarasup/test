...
class ConfuseBiz(object):
    ...
    def confuse_text(text):
        firstArray = ['usr', 'share', 'dict', 'words', 'upload','version', 'change', 'add', 'note', 'algorithm','argument' , 'array', 'assignment', 'brackets', 'call', 'comment', 'compile', 'constant', 'debug', 'execute', 'function', 'implement', 'meet', 'go', 'deal', 'repeat']
        secondArray = ['Syntax', 'Type', 'Value', 'Variable', 'Member', 'Object', 'Code','Modulus', 'Boolean', 'Binary', 'Nested', 'Index', 'Parameter', 'Value', 'Scope', 'Modularity', 'Bytes', 'Interpreter', 'Properties']
        thirdArray = ['Up', 'Down', 'Straght', 'Right', 'Jump', 'Into', 'Fox','Glide','Pur','Phone','Neither','Either','It','Well','Ruling','Song','Sip']
        forthArray = ['String', 'Double', 'Argument', 'Bind', 'Search', 'Block','Bug','Model','Clojure','Compute','Concat','Statement','Flow','Editor','DOM','Else']
        fifthArray = ['Flag', 'Point', 'Exception', 'Testing', 'Hash', 'Label', 'Loop', 'Mercurial', 'Modulo', 'Overload', 'Parse', 'Package', 'Vector', 'Buffering', 'Unit', 'Thread', 'Subscript', 'Stack', 'Rust', 'Random']
...
if __name__ == '__main__':
    ...
    for item in diff_identifiers:
        ...
        if randomNum == 0:
            confused_dict[item] = random.choice(['pac_', 'acd_', 'bos_', 'dev_', 'view_', 'gen_', 'dis_', 'func_']) + item
        else:
